...
namespace Blog.Controllers
{
    public class ArticleController : Controller
    {
        ...
        public ActionResult Create(Article article)
        {
            ...
            {
                var authorId = database.Users.Where(u => u.UserName == User.Identity.Name).FirstOrDefault().Id;
        ...
        public ActionResult Edit(int id, ArticleViewModel model)
        {
            if (ModelState.IsValid)
            {
                var article = database.Articles.Where(a => a.Id == model.Id).Include(a => a.Author).FirstOrDefault();
        ...
        {
            var article = database.Articles.Include(a => a.Author).First(m => m.Id == id);
            if (article == null)
            {
                return NotFound();
            }
